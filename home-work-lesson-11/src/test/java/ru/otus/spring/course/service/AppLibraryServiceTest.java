...
public class AppLibraryServiceTest {
    ...
    void getBooksByPublishedYearGreaterThan() {
        ...
        when(bookRepository.findByPublishedYearGreaterThan(year)).thenReturn(books);

        assertEquals(books, appLibraryService.getBooksByPublishedYearGreaterThan(year));
        verify(bookRepository).findByPublishedYearGreaterThan(year);
    }

    @Test
    void getBooksWhereAuthorsMoreThan() {
        Set<Book> books = new HashSet<>(){{add(EntityUtils.createBook());}};
    ...
    void getAuthorsWhereBooksMoreThan() {
        Set<Author> authors = new HashSet<>(){{add(EntityUtils.createAuthor());}};
    ...
    void getAuthorsByName() {
        Author author = EntityUtils.createAuthor();
        Set<Author> authors = new HashSet<>(){{add(author);}};
