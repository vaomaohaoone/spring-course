...
public class MigrationConfig {
    ...
    @ChangeSet(order = "007", id = "insertUser", author = "timofeev")
    public void insertUser(DB db) {
        DBCollection dbCollection = db.getCollection("users");
        BasicDBObject doc = new BasicDBObject()
                .append("name", "admin")
                .append("password", new BCryptPasswordEncoder().encode("admin"));
        dbCollection.insert(doc);
    }
    ...
    public void insertCommenter(DB db) {
        DBCollection dbCollection = db.getCollection("users");
        BasicDBObject doc = new BasicDBObject()
                .append("name", "commenter")
                .append("password", new BCryptPasswordEncoder().encode("commenter") )
                .append("role", "COMMENTER");
        dbCollection.insert(doc);
    }*/
