...
public class AppShell {
    ...
    public void createBook(@ShellOption String name, @ShellOption int year){
        ...
        System.out.println("The book with name: " + book.getName() + ", published year: " + book.getPublishedYear() + " and isbn: " + book.getIsbn() + " was created");
    }
    ...
    public void createStyle(@ShellOption String style) {
        ...
        System.out.println("Style with name: " + styleEntity.getName() + " was created");
    }

    @ShellMethod(key = {"link-author-and-book", "abl"}, value = "link author and book by author id and isbn book")
    public void linkAuthorAndBook(@ShellOption UUID authorId, @ShellOption UUID isbn) {
    ...
    public void getAllAuthorsOfBook(@ShellOption UUID isbn) {
        List<Author> authors = appLibraryService.getAllAuthorsOfBook(isbn);
    ...
    public void getAllBooksByAuthor(@ShellOption UUID authorId) {
        List<Book> books = appLibraryService.getAllBooksByAuthor(authorId);
        System.out.println("Books fot author with id: " + authorId);
        for (Book book: books) {
            System.out.println("Book with name: " + book.getName() + ", published year: " + book.getPublishedYear() + ", isbn: " + book.getIsbn());
        }
    }
